...
import WeSpecializeCard from "@/components/home/weSpecializeInCard";
import WeSpecializeFrame from "@/components/home/weSpcializeInFrame";
    ...
    return (
        <WeSpecializeFrame height={"fit-content"}>
            ...
            >
                ...
                <WeSpecializeCard radius={8} heightPx={200}>
                    <Stack width={"100%"} flexGrow={1} alignItems="center" justifyContent="center" gap={2} paddingY={2.5}>
                        ...
                        <Stack width={"100%"} gap={1}>
                            <Stack width={"100%"} direction={"row"} alignItems={"center"} justifyContent={"space-between"} gap={1} paddingX={2}>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={eth} width={25} height={25} alt="eth" style={{
                                ...
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={sol} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={base} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={arb} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                            </Stack>
                            <Stack width={"100%"} direction={"row"} alignItems={"center"} justifyContent={"space-between"} gap={1} paddingX={2}>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={opt} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={chainlink} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={file} width={17} height={17} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)",
                                ...
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={btc} width={20} height={20} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                            </Stack>
                        ...
                        <Stack width={"100%"} gap={1}>
                            ...
                            <Stack width={"100%"} direction={"row"} alignItems={"center"} justifyContent={"space-between"} gap={1} paddingX={2}>
                                ...
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={figma} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)",
                                        scale: 0.7
                                    }}></Image>
                                </Stack>
                ...
                <WeSpecializeCard radius={8} heightPx={200}>
                    <Stack width={"100%"} flexGrow={1} alignItems="center" justifyContent="center" gap={2} paddingY={2.5}>
                        <Typography variant="h5" textAlign="center" fontWeight={500}><span style={{ color: theme.palette.brand.mgsBlue1.main }}>AI</span><br />Integration</Typography>
                        <Stack width={"100%"} gap={1}>
                            <Stack width={"100%"} direction={"row"} alignItems={"center"} justifyContent={"space-between"} gap={1} paddingX={2}>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    background: "linear-gradient(180deg, rgba(47,47,47,0.61) 0%, rgba(149,149,149,0.40) 100%)",
                            ...
                            <Stack width={"100%"} direction={"row"} alignItems={"center"} justifyContent={"space-between"} gap={1} paddingX={2}>
                                ...
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={perp} width={20} height={20} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)"
                                    }}></Image>
                                </Stack>
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={copilot} width={25} height={25} alt="eth" style={{
                                        filter: "brightness(0) invert(0.8)",
                                ...
                                <Stack alignItems={"center"} justifyContent={"center"} padding={1} sx={{
                                    ...
                                    <Image src={hf} width={16} height={16} alt="eth" style={{
                                        scale: 1.4
                                    }}></Image>
                                </Stack>
                            </Stack>
