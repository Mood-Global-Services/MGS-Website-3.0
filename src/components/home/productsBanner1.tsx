...
import ProductsShape1 from "@/assets/images/productsShape1.webp";
import ProductsIcon1 from "@/assets/images/productsIcon1.webp";
        ...
        <Grid container spacing={2} justifyContent="center" alignItems="center" sx={{
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={sol} alt="Solana" width={20} height={20} style={{
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={polygon} alt="Polygon" width={20} height={20} style={{
                filter: "grayscale(100%)"
              }} />
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={eth} alt="Ethereum" width={20} height={20} style={{
                filter: "grayscale(100%)"
              }} />
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={avalanche} alt="Avalanche" width={20} height={20} style={{
                filter: "grayscale(100%)"
              }} />
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={btc} alt="Bitcoin" width={20} height={20} style={{
                filter: "grayscale(100%)"
              }} />
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={arb} alt="Arbitrum" width={20} height={20} style={{
                filter: "grayscale(100%)"
              }} />
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Image src={aptos} alt="Aptos" width={20} height={20} style={{
                filter: "grayscale(100%)"
              }} />
          ...
          <Grid size={{ xs: 6, md: 6 }} sx={{
            ...
            <Stack width="100%" direction="row" alignItems="center" justifyContent="center" gap={2}>
              <Typography component="span" variant="h6" fontWeight={400} color={"#34B2FF"}>+50 more</Typography>
            </Stack>
          </Grid>
